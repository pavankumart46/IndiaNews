...
public class SecondActivity extends AppCompatActivity implements
    ...
    public static final String SHARED_PREFERENCES_KEY = "LOGIN_STATE";
    public static final String SHARED_PREFERENCES_VALUE = "LOGIN_STATUS";
    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        ...
        if (user == null) {
            ...
            editor.putBoolean(SHARED_PREFERENCES_VALUE,true);
            editor.apply();
